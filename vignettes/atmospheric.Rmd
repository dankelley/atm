...
soundingFile <- downloadAtmosphericSounding()
sounding <- readAtmosphericSounding(soundingFile)
plotAtmosphericSounding(sounding)
# Clean up files for the R vignette.  In practice, though, there is
# no real problem in retaining the files unless the computer has very
# little free storage.
unlink(soundingFile)
```
